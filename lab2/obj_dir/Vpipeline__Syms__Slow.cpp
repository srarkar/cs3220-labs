    ...
    , TOP{this, namep}
{
    ...
    TOP__pipeline__my_FE_stage.ctor(this, "pipeline.my_FE_stage");
    ...
    // Setup scopes
    __Vscopep_pipeline__my_FE_stage = new VerilatedScope{this, "pipeline.my_FE_stage", "my_FE_stage", "<null>", 0, VerilatedScope::SCOPE_OTHER};
    ...
    __Vscopep_pipeline__my_FE_stage->varInsert("correct_branch_predictions", &(TOP__pipeline__my_FE_stage.correct_branch_predictions), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW|VLVF_SIGNED, 0, 1 ,31,0);
    __Vscopep_pipeline__my_FE_stage->varInsert("total_branch_predictions", &(TOP__pipeline__my_FE_stage.total_branch_predictions), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW|VLVF_SIGNED, 0, 1 ,31,0);
...
Vpipeline__Syms::~Vpipeline__Syms() {
    // Tear down scopes
    VL_DO_CLEAR(delete __Vscopep_pipeline__my_FE_stage, __Vscopep_pipeline__my_FE_stage = nullptr);
    ...
    TOP__pipeline__my_FE_stage.dtor();
    TOP__pipeline.dtor();
}
