...
void Vtb_axi4_ram_tb_axi4_ram___nba_sequent__TOP__tb_axi4_ram__0(Vtb_axi4_ram_tb_axi4_ram* vlSelf) {
    ...
    if (VL_UNLIKELY((((IData)(vlSelfRef.__PVT__axi_ram_inst__DOT__write_state_reg) 
                      != (IData)(vlSelfRef.__PVT__axi_ram_inst__DOT__write_state_next))))) {
        VL_WRITEF_NX("t=%0t WRITE state %0# -> %0#\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,2,
                     (IData)(vlSelfRef.__PVT__axi_ram_inst__DOT__write_state_reg),
                     2,vlSelfRef.__PVT__axi_ram_inst__DOT__write_state_next);
    }
